...
const CATEGORIES = [
  {
    ...
    description: "Siparis durumu, kargo ve teslimat bildirimleri",
    emailKey: "email_orders" as const,
    pushKey: "push_orders" as const,
  },
  {
    title: "Kampanya ve Indirimler",
    description: "Ozel firsatlar, indirimler ve kampanya duyurulari",
    emailKey: "email_promotions" as const,
    pushKey: "push_promotions" as const,
  },
  {
    title: "Stok Uyarilari",
    description: "Takip ettiginiz urunler tekrar stoga girdiginde",
    emailKey: "email_stock_alerts" as const,
    pushKey: "push_stock_alerts" as const,
  },
  {
    title: "Sepet Hatirlatmalari",
    description: "Sepetinizdeki urunler hakkinda hatirlatmalar",
    emailKey: null,
    pushKey: "push_cart_reminders" as const,
  },
  {
    title: "E-Bulten",
    description: "Haftalik yeni urunler ve oneriler",
...
export default function NotificationPreferencesForm({
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      setMessage({ type: "error", text: "Baglanti hatasi olustu." });
    } finally {
      setSaving(false);
    }
  }, [preferences]);
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground">
        Hangi bildirimleri almak istediginizi asagidan secebilirsiniz.
      </p>
