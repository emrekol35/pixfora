...
export default function NewsletterUnsubscribePage() {
  ...
  const handleUnsubscribe = useCallback(async () => {
    if (!email) {
      setStatus("error");
      setMessage("E-posta adresi bulunamadi.");
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        setStatus("success");
        setMessage(data.message || "Aboneliginiz basariyla iptal edildi.");
      } else {
        setStatus("error");
      ...
      <div className="max-w-md w-full text-center">
        {status === "success" ? (
          <>
            ...
            <h1 className="text-2xl font-bold mb-3">Abonelik Iptal Edildi</h1>
          ...
          <>
            ...
            <h1 className="text-2xl font-bold mb-3">Abonelikten Cik</h1>
            <p className="text-muted-foreground mb-2">
              E-bulten aboneliginizi iptal etmek istediginizden emin misiniz?
            </p>
            {email && (
            ...
            <div className="flex gap-3 justify-center">
              ...
              >
                {status === "loading" ? "Isleniyor..." : "Aboneligi Iptal Et"}
              </button>
            </div>
          </>
        )}
