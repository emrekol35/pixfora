...
async function confirmSubscription(token: string | null) {
  if (!token) return { success: false, message: "Gecersiz link" };
  ...
  try {
    ...
    return { success: false, message: data.error || "Bir hata olustu" };
  } catch {
    return { success: false, message: "Baglanti hatasi olustu" };
  }
}
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-3">
          {result.success ? "Abonelik Onaylandi!" : "Onay Basarisiz"}
        </h1>
